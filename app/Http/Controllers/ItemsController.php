...
class ItemsController extends Controller
{
	...
	public function editProfile1(SellRequest $request)
 {
	 $item=Item::item();
...
public function store(Request $request)
{
    ...
    return back();
     ...
     public function showItemDetail1(Item $item)
     {
         return view('items.item_hensyu')
             ->with('item1', $item);
     }
     ...
     public function showBuyItemForm1(Item $item)
     {
         if (!$item->isStateSelling) {
             abort(404);
         }

         return view('items.item_hensyu_form')
             ->with('item1',$item);
     }
