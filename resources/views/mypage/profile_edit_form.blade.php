...
@section('content')
    <div id="profile-edit-form" class="container">
        ...
        <div class="row">
			...
			<label for="gakuseki">学籍番号:{{$user->gakuseki}}
		    </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input id="zyusyo" type="text" class="form-control @error('zyusyo') is-invalid @enderror" name="zyusyo" value="{{ old('zyusyo', $user->zyusyo) }}" required autocomplete="zyusyo" autofocus>
                        @error('zyusyo')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
